...
<a href="{BASE}/tonight/{user}">🎲 <span title="Pick a random recommendation">Tonight</span></a> <a href="{BASE}/stats/{user}" title="Your rating stats">📊</a> <a href="{BASE}/export/{user}" title="Export ratings as CSV">⬇</a> <a href="{BASE}/enrich" title="Enrich titles with metadata">⚡</a> <a href="{BASE}/recs/{user}" title="Personalized recommendations">🎯 Recs</a> <a href="{BASE}/catalog" title="Streaming catalog">📺</a> <a href="{BASE}/new" title="New on streaming">🆕</a> <a href="{BASE}/random/{user}" title="Random unwatched title">🎰</a> <a href="{BASE}/compare/" title="Compare users">👥</a> <a href="{BASE}/rss/{user}" title="RSS feed of your ratings">📡</a> <a href="{BASE}/library/{user}" title="Library curation">📚 Library</a> <a href="{BASE}/setup/{user}" title="Setup & configuration">⚙</a>
