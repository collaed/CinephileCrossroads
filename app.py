...
def render_setup(user):
    ...
    html += '<label>OpenSubtitles.org username</label><input name="opensubs_user" value="' + _load_key('opensubs_user') + '">'
    html += '<label>OpenSubtitles.org password</label><input name="opensubs_pass" type="password" value="' + _load_key('opensubs_pass') + '">'
